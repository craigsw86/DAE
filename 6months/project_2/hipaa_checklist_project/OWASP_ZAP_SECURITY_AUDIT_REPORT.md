...
| Metric | Value | Status |
|--------|-------|--------|
| **Overall Security Score** | 31.3% |  Poor |
| **HTTPS Security** | 37.5% |  Poor |
| **JWT Security** | 25.0% |  Poor |
| **Authentication Security** | 60.0% |  Fair |
| **API Security** | 60.0% |  Fair |
| **Vulnerabilities** | 1 Medium |  Low Risk |
...
- **A04: Insecure Design**:  Partially Compliant
- **A05: Security Misconfiguration**:  Partially Compliant
