...
def show_hipaa_usage():
    ...
    print("1⃣ WHAT'S NOW AVAILABLE IN YOUR SYSTEM")
    print("-" * 40)
    ...
    print("2⃣ SAMPLE REGULATION DETAILS")
    print("-" * 40)
    ...
    print("3⃣ HOW TO USE IN YOUR CODE")
    print("-" * 40)
    ...
    print("4⃣ CURRENT CHECKLIST ITEMS")
    print("-" * 40)
