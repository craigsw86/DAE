...
<div style="text-align:center; margin-bottom:2rem; padding:1.5rem; background:#f8f9fa; border-radius:8px;">
  ...
  <p style="margin:0; color:#7f8c8d;">📧 craig.s.weinstein@email.com | 🔗 LinkedIn: /in/craig-weinstein | 🐙 GitHub: /craigsw86</p>
</div>
...
**GRC Analyst Intern** | *TechSecure Solutions* | *Jun 2024 - Present*
...
**HIPAA Checklist** | *Python, Django, JavaScript, React*
- 

**HIPAA Deadline Shredding Reminder** | *Python, SQLite*
- 
