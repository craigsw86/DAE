...
<div style="text-align:center; margin-bottom:3rem;">
  <img src="{{ '/assets/img/portrait.jpg' | relative_url }}" alt="Craig Weinstein" 
...
<div style="display:grid; gap:1.5rem; margin:2rem 0;">
  ...
  <div style="background:#f8f9fa; padding:1.5rem; border-radius:8px; border-left:4px solid #007bff;">
    ...
    <p style="margin:0; font-size:1.1rem;"><a href="mailto:craig.s.weinsteni@email.com" style="color:#007bff; text-decoration:none;">craig.s.weinsteni@email.com</a></p>
  ...
  <div style="background:#f8f9fa; padding:1.5rem; border-radius:8px; border-left:4px solid #0077b5;">
    ...
    <p style="margin:0; font-size:1.1rem;"><a href="https://linkedin.com/in/craig-weinstein" style="color:#0077b5; text-decoration:none;">linkedin.com/in/craig-weinstein</a></p>
  ...
  <div style="background:#f8f9fa; padding:1.5rem; border-radius:8px; border-left:4px solid #333;">
    ...
    <p style="margin:0; font-size:1.1rem;"><a href="https://github.com/craigsw86" style="color:#333; text-decoration:none;">github.com/craigsw86</a></p>
...
<div style="background:#e8f4fd; padding:2rem; border-radius:8px; margin:2rem 0;">
  <h3 style="margin:0 0 1rem; color:#2c3e50;">GRC Analysis Opportunities</h3>
...
<div style="text-align:center; margin-top:3rem; padding:2rem; background:#f8f9fa; border-radius:8px;">
  ...
  <a href="mailto:craig.s.weinstein@email.com" style="background:#007bff; color:white; padding:0.75rem 1.5rem; text-decoration:none; border-radius:6px; font-weight:bold; display:inline-block;">Send me an email</a>
